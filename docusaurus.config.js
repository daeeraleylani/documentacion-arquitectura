...
const config = {
  title: 'Patrones',
  tagline: 'de diseño creacionales',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © ${new Date().getFullYear()} Universidad Tecnologica de la Sierra Hidalgense. Pagina hecha con fines educativos.`,
      },
      prism: {
